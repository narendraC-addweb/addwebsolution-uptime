...
- Do not report any upstream dependency issues / scan result by any tools. It will be closed immediately without explanations. Unless you have PoC to prove that the upstream issue affected Addweb Solution.
...
### Addweb Solution Versions

You should use or upgrade to the latest version of Addweb Solution.
